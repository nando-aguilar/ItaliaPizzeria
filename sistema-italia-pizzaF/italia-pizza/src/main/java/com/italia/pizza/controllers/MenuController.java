...
public class MenuController {
    ...
    // Inyección de las cuatro tablas desde el FXML
    ...
    @FXML private TableView<MenuTablas.UsuarioReciente> tablaVistaUsuariosRecientes; // <--- AGREGADA
    ...
    private void configurarColumnas() {
        ...
        configurarTabla(tablaVistaPedidos, "ID", "id", "Fecha", "fecha", "Total", "total", "Estatus", "estatus_actual", "Cliente", "cliente_nombre", "Empleado", "empleado_nombre");
        configurarTabla(tablaVistaDetalles, "ID", "id", "ID Pedido", "id_pedido", "Producto", "producto", "Cantidad", "cantidad", "Precio U.", "precio_unitario", "Subtotal", "subtotal");
        // Nueva configuración para la cuarta tabla
        configurarTabla(tablaVistaUsuariosRecientes, "ID", "id", "Nombre", "nombre", "Tipo", "tipo", "Estatus", "estatus");
    }
    ...
    private void aplicarPermisos() {
        ...
        boolean isAdmin = "ADMIN".equals(rolUsuario);
